...
// http://localhost:8080/role?fName=John&lName=Ulmer&birthday=Oct&bio=test	
		List<Role> roleList = roleRepository.findPersonBySearch(fName, lName, birthday, bio);
        return roleList;
	}
...
// 		Role r = new Role("john", "ulmer", "oct", "string string string"); 
	...
	//to test, go to postman > PUT > role/id > Body > "raw" radio button > fields to update in {} & ""
